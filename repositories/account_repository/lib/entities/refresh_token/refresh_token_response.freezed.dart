...
class _$_RefreshTokenResponse implements _RefreshTokenResponse {
  const _$_RefreshTokenResponse({this.data, this.metaData});
  ...
  @override
  String toString() {
    return 'RefreshTokenResponse(data: $data, metaData: $metaData)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_RefreshTokenResponseToJson(this);
  }
}
...
abstract class _RefreshTokenResponse implements RefreshTokenResponse {
  const factory _RefreshTokenResponse(
      {final DataResponse? data,
      final MetaData? metaData}) = _$_RefreshTokenResponse;
